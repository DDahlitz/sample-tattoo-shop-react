  ...
  return (
    <header className= {`${isActive ? 'h-[100px] lg:h-[110px] shadow-lg' 
      ...
      <div className='flex justify-between items-center h-full pl-[50px] pr-[60px]'>
        ...
        <div className='fixed bg-red-500 w-full h-full left-0 right-0 -z-10 transition-all duration-300'>
          < NavMobile />
        </div>
      </div>
    </header>
