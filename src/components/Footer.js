        ...
        <motion.div
          ...
          <motion.div variants = { fadeIn('up') } className = 'flex-1'>
            ...
            <form className = 'flex  justify-between items-start border-b border-[#B6B6B6]'>
              <input className = 'outline-none placeholder:text-base italic placeholder:capitalize  bg-transparent pb-2' type = 'text' placeholder = { newsletter.form.placeholder }/>
